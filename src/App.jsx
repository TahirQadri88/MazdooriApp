...
// ==========================================
const KARACHI_AREAS = [
  // --- South (Old City / Saddar / DHA) ---
  { name: 'Bolton Market',            fromShop: 0.5,  fromWarehouse: 8.5  },
  { name: 'Jodia Bazaar',             fromShop: 0.5,  fromWarehouse: 8.5  },
  { name: 'Jama Cloth Market',        fromShop: 1.0,  fromWarehouse: 7.5  },
  { name: 'Lighthouse',               fromShop: 1.0,  fromWarehouse: 7.5  },
  { name: 'Burns Road',               fromShop: 1.5,  fromWarehouse: 7.0  },
  { name: 'Civil Hospital',           fromShop: 1.5,  fromWarehouse: 8.0  },
  { name: 'Dow University Hospital',  fromShop: 1.5,  fromWarehouse: 8.0  },
  { name: 'I.I. Chundrigar Road',     fromShop: 1.5,  fromWarehouse: 8.5  },
  { name: 'Ranchore Line',            fromShop: 1.5,  fromWarehouse: 7.5  },
  { name: 'Lea Market',               fromShop: 1.5,  fromWarehouse: 10.0 },
  { name: 'Regal Chowk',             fromShop: 2.0,  fromWarehouse: 7.5  },
  { name: 'Tibet Centre',             fromShop: 2.0,  fromWarehouse: 6.5  },
  { name: 'Bohri Bazaar',             fromShop: 2.5,  fromWarehouse: 8.0  },
  { name: 'Kharadar / Old Town',      fromShop: 2.5,  fromWarehouse: 13.5 },
  { name: 'Saddar',                   fromShop: 2.5,  fromWarehouse: 8.0  },
  { name: 'Empress Market',           fromShop: 3.0,  fromWarehouse: 8.5  },
  { name: 'West Wharf',               fromShop: 3.5,  fromWarehouse: 11.0 },
  { name: 'Lyari',                    fromShop: 4.0,  fromWarehouse: 10.0 },
  { name: 'Frere Hall',               fromShop: 4.5,  fromWarehouse: 8.5  },
  { name: 'Garden / Soldier Bazar',   fromShop: 4.5,  fromWarehouse: 6.0  },
  { name: 'Karachi Cantt',            fromShop: 4.5,  fromWarehouse: 9.0  },
  { name: 'Clifton',                  fromShop: 6.0,  fromWarehouse: 11.0 },
  { name: 'DHA Phase 1',              fromShop: 6.0,  fromWarehouse: 10.0 },
  { name: 'Teen Talwar',              fromShop: 6.0,  fromWarehouse: 11.0 },
  { name: 'Boat Basin',               fromShop: 7.0,  fromWarehouse: 12.0 },
  { name: 'Zamzama',                  fromShop: 8.0,  fromWarehouse: 13.0 },
  { name: 'DHA Phase 2',              fromShop: 8.5,  fromWarehouse: 12.0 },
  { name: 'DHA Phase 3',              fromShop: 9.5,  fromWarehouse: 13.0 },
  { name: 'DHA Phase 4',              fromShop: 10.5, fromWarehouse: 14.0 },
  { name: 'DHA Phase 5',              fromShop: 10.5, fromWarehouse: 14.5 },
  { name: 'Emaar Oceanfront / Seaview', fromShop: 11.0, fromWarehouse: 15.0 },
  { name: 'DHA Phase 7',              fromShop: 11.5, fromWarehouse: 15.5 },
  { name: 'DHA Phase 6',              fromShop: 12.5, fromWarehouse: 16.0 },
  { name: 'DHA Phase 8',              fromShop: 15.0, fromWarehouse: 18.0 },
  // --- East (Saddar East / Gulshan / Johar) ---
  { name: 'Guru Mandir',              fromShop: 3.5,  fromWarehouse: 5.0  },
  { name: 'Lines Area',               fromShop: 4.0,  fromWarehouse: 7.0  },
  { name: 'Jamshed Road',             fromShop: 4.5,  fromWarehouse: 4.0  },
  { name: 'Jamshed Quarters',         fromShop: 4.5,  fromWarehouse: 4.0  },
  { name: 'New Town',                 fromShop: 6.0,  fromWarehouse: 3.0  },
  { name: 'PECHS',                    fromShop: 7.5,  fromWarehouse: 4.0  },
  { name: 'Tariq Road',               fromShop: 7.5,  fromWarehouse: 4.0  },
  { name: 'Shahrah-e-Faisal',         fromShop: 8.0,  fromWarehouse: 6.0  },
  { name: 'KDA Scheme 1 (Karsaz)',    fromShop: 8.5,  fromWarehouse: 3.0  },
  { name: 'Sharafabad / CP Berar',    fromShop: 8.5,  fromWarehouse: 2.5  },
  { name: 'Bahadurabad',              fromShop: 9.0,  fromWarehouse: 3.0  },
  { name: 'Falcon Complex (AFOHS)',   fromShop: 13.0, fromWarehouse: 6.0  },
  { name: 'Gulberg',                  fromShop: 13.0, fromWarehouse: 6.5  },
  { name: 'Gulshan Block 14',         fromShop: 12.5, fromWarehouse: 2.5  },
  { name: 'Gulshan Block 2',          fromShop: 13.0, fromWarehouse: 3.5  },
  { name: 'Gulshan Block 3',          fromShop: 13.0, fromWarehouse: 3.5  },
  { name: 'University Road',          fromShop: 13.0, fromWarehouse: 1.0  },
  { name: 'Gulshan-e-Iqbal',          fromShop: 14.0, fromWarehouse: 4.5  },
  { name: 'Askari 4 (Rashid Minhas)', fromShop: 14.0, fromWarehouse: 4.5  },
  { name: 'Faisal Cantonment',        fromShop: 14.0, fromWarehouse: 7.0  },
  { name: 'Abul Hassan Isphahani Rd', fromShop: 15.0, fromWarehouse: 6.0  },
  { name: 'Askari 14 (Drigh Road)',   fromShop: 14.0, fromWarehouse: 8.0  },
  { name: 'Drigh Road',               fromShop: 15.0, fromWarehouse: 8.0  },
  { name: 'Gulshan Block 7',          fromShop: 14.5, fromWarehouse: 4.0  },
  { name: 'Johar More',               fromShop: 15.0, fromWarehouse: 5.5  },
  { name: 'Gulshan Block 13',         fromShop: 15.0, fromWarehouse: 5.0  },
  { name: 'Rashid Minhas Road',       fromShop: 16.0, fromWarehouse: 5.0  },
  { name: 'Gulshan Block 6',          fromShop: 15.0, fromWarehouse: 5.5  },
  { name: 'Gulshan Block 10A',        fromShop: 16.5, fromWarehouse: 7.0  },
  { name: 'Johar Chowrangi',          fromShop: 16.5, fromWarehouse: 7.5  },
  { name: 'Sohrab Goth',              fromShop: 16.5, fromWarehouse: 10.0 },
  { name: 'Gulistan-e-Jauhar',        fromShop: 17.0, fromWarehouse: 8.0  },
  { name: 'Karachi University',       fromShop: 17.5, fromWarehouse: 7.0  },
  { name: 'Karachi Airport',          fromShop: 18.0, fromWarehouse: 12.0 },
  { name: 'Saadi Town',               fromShop: 18.0, fromWarehouse: 9.0  },
  { name: 'Safoora',                  fromShop: 18.0, fromWarehouse: 9.0  },
  { name: 'Scheme 33',                fromShop: 20.0, fromWarehouse: 11.0 },
  // --- Central (Liaquatabad / Nazimabad / FB Area) ---
  { name: 'Lasbela Chowk',           fromShop: 5.0,  fromWarehouse: 6.0  },
  { name: 'Teen Hatti',               fromShop: 6.0,  fromWarehouse: 4.0  },
  { name: 'Liaquatabad',              fromShop: 9.0,  fromWarehouse: 6.0  },
  { name: 'Ayesha Manzil',            fromShop: 9.0,  fromWarehouse: 6.5  },
  { name: 'Nazimabad',                fromShop: 9.0,  fromWarehouse: 8.0  },
  { name: 'Liaquatabad No.10',        fromShop: 10.0, fromWarehouse: 5.0  },
  { name: 'Paposh Nagar',             fromShop: 10.5, fromWarehouse: 8.0  },
  { name: 'Hussainabad (FB Area)',     fromShop: 11.0, fromWarehouse: 6.0  },
  { name: 'Azizabad (FB Area)',        fromShop: 12.0, fromWarehouse: 7.0  },
  { name: 'North Nazimabad',          fromShop: 12.5, fromWarehouse: 9.5  },
  { name: 'Federal B Area',           fromShop: 13.0, fromWarehouse: 8.0  },
  { name: 'Buffer Zone',              fromShop: 14.5, fromWarehouse: 10.0 },
  { name: 'Naya Nazimabad',           fromShop: 15.0, fromWarehouse: 12.0 },
  { name: 'Nagan Chowrangi',          fromShop: 16.0, fromWarehouse: 12.0 },
  { name: 'North Karachi',            fromShop: 18.0, fromWarehouse: 14.0 },
  { name: 'New Karachi',              fromShop: 19.5, fromWarehouse: 15.5 },
  // --- West (SITE / Orangi / Surjani) ---
  { name: 'Shershah',                 fromShop: 8.0,  fromWarehouse: 14.0 },
  { name: 'SITE Area',                fromShop: 9.0,  fromWarehouse: 11.0 },
  { name: 'Metroville',               fromShop: 12.0, fromWarehouse: 11.0 },
  { name: 'Orangi Town',              fromShop: 15.5, fromWarehouse: 12.5 },
  { name: 'Manghopir',               fromShop: 16.5, fromWarehouse: 15.0 },
  { name: 'Surjani Town',             fromShop: 24.0, fromWarehouse: 19.0 },
  // --- Keamari ---
  { name: 'Kemari',                   fromShop: 7.0,  fromWarehouse: 14.0 },
  { name: 'Mauripur',                 fromShop: 12.0, fromWarehouse: 20.0 },
  { name: 'Baldia Town',              fromShop: 14.0, fromWarehouse: 18.0 },
  // --- Korangi ---
  { name: 'Korangi Causeway',         fromShop: 14.5, fromWarehouse: 11.5 },
  { name: 'Korangi No. 1',            fromShop: 16.0, fromWarehouse: 13.0 },
  { name: 'Korangi No. 1.5',          fromShop: 16.5, fromWarehouse: 13.5 },
  { name: 'Korangi No. 2',            fromShop: 17.0, fromWarehouse: 14.0 },
  { name: 'Shah Faisal Colony',       fromShop: 17.0, fromWarehouse: 11.0 },
  { name: 'Korangi No. 2.5',          fromShop: 17.5, fromWarehouse: 14.5 },
  { name: 'Korangi No. 3',            fromShop: 18.0, fromWarehouse: 15.0 },
  { name: 'Korangi Industrial Area',  fromShop: 18.5, fromWarehouse: 16.5 },
  { name: 'Korangi No. 3.5',          fromShop: 18.5, fromWarehouse: 15.5 },
  { name: 'Korangi No. 4',            fromShop: 19.0, fromWarehouse: 16.0 },
  { name: 'Korangi No. 4.5',          fromShop: 19.5, fromWarehouse: 16.5 },
  { name: 'Korangi No. 5',            fromShop: 20.0, fromWarehouse: 17.0 },
  { name: 'Korangi No. 5.5',          fromShop: 20.5, fromWarehouse: 17.5 },
  { name: 'Korangi No. 6',            fromShop: 21.0, fromWarehouse: 18.0 },
  { name: 'Korangi Creek',            fromShop: 21.5, fromWarehouse: 19.0 },
  { name: 'Babar Market Landhi',      fromShop: 24.5, fromWarehouse: 19.5 },
  { name: 'Landhi',                   fromShop: 25.0, fromWarehouse: 21.0 },
  { name: 'Khurram Abad Landhi',      fromShop: 25.5, fromWarehouse: 20.0 },
  // --- Malir ---
  { name: 'Al-Falah Society / Shamsi',fromShop: 18.0, fromWarehouse: 11.5 },
  { name: 'Model Colony',             fromShop: 21.0, fromWarehouse: 14.0 },
  { name: 'Malir',                    fromShop: 22.0, fromWarehouse: 15.0 },
  { name: 'Quaidabad',                fromShop: 24.0, fromWarehouse: 18.0 },
  { name: 'Malir Cantonment',         fromShop: 26.0, fromWarehouse: 17.5 },
  { name: 'Saudabad',                 fromShop: 23.0, fromWarehouse: 16.0 },
  { name: 'Askari 11 (Malir Cantt)',  fromShop: 23.0, fromWarehouse: 15.0 },
  { name: 'Bhains Colony / Cattle Colony', fromShop: 28.0, fromWarehouse: 24.5 },
  { name: 'Bin Qasim',                fromShop: 40.0, fromWarehouse: 33.0 },
  { name: 'Steel Town',               fromShop: 41.0, fromWarehouse: 34.0 },
  { name: 'Gadap Town',               fromShop: 41.5, fromWarehouse: 32.5 },
  { name: 'Gadap Abdullah Hotel',     fromShop: 41.5, fromWarehouse: 32.5 },
  { name: 'Gadap Jumani Goth',        fromShop: 42.5, fromWarehouse: 33.5 },
  { name: 'Gulshan-e-Hadeed',         fromShop: 43.0, fromWarehouse: 36.0 },
  { name: 'Gadap Farms Area',         fromShop: 44.5, fromWarehouse: 35.5 },
  { name: 'Port Qasim',               fromShop: 45.0, fromWarehouse: 38.0 },
  // --- Highway (Super Highway / M9 / M10) ---
  { name: 'Superhighway (Near)',       fromShop: 22.0, fromWarehouse: 13.0 },
  { name: 'Ahsanabad',                fromShop: 21.0, fromWarehouse: 12.0 },
  { name: 'Northern Bypass (M-10)',   fromShop: 26.0, fromWarehouse: 22.0 },
  { name: 'Taiser Town / M9',         fromShop: 30.0, fromWarehouse: 21.0 },
  { name: 'Jameel Memon Society S/W', fromShop: 31.5, fromWarehouse: 22.0 },
  { name: 'Dumba Goth',               fromShop: 34.5, fromWarehouse: 25.0 },
  { name: 'Ramzan Piri Highway',      fromShop: 35.5, fromWarehouse: 26.5 },
  { name: 'Nagori Society',           fromShop: 38.5, fromWarehouse: 29.5 },
  { name: 'Bahria Town',              fromShop: 45.0, fromWarehouse: 35.0 },
  { name: 'Superhighway Far',         fromShop: 45.0, fromWarehouse: 35.0 },
  { name: 'DHA City (Phase 9)',        fromShop: 55.0, fromWarehouse: 45.0 },
  // --- Outskirts ---
  { name: 'Hub',                      fromShop: 28.0, fromWarehouse: 31.0 },
  { name: 'Thatta / Gharo',           fromShop: 75.0, fromWarehouse: 68.0 },
];
...
function RiderPayDash({ dispatches, ridesUser, riderAdvances }) {
  ...
  const periodAdvances = myAdvances.filter(inPeriod);
  ...
  return (
    <div className="space-y-4 pb-10">
      ...
      {myPending.length > 0 && (
        <div className="bg-amber-50 border-2 border-amber-200 rounded-3xl p-4 space-y-2">
          <div className="flex items-center justify-between">
            <span className="font-black text-amber-700 flex items-center gap-1 text-sm" style={isRickshaw ? uf : {}}>
              <Clock size={14}/> {t('Awaiting Approval', 'تصدیق کا انتظار')}
            </span>
            <span className="text-[10px] font-black text-amber-600 bg-amber-200 px-2 py-0.5 rounded-full">{myPending.length}</span>
          </div>
          {myPending.map(d => (
          ...
          <div className="text-[9px] text-amber-600 font-bold text-center pt-1" style={isRickshaw ? uf : {}}>
            {t('Included after admin approval', 'ادارے کی تصدیق کے بعد شامل ہوگا')}
          </div>
        </div>
      )}
      ...
      <button onClick={() => setShowLedger(v => !v)}
        className="w-full flex justify-between items-center py-2.5 px-4 bg-slate-50 border-2 border-slate-200 rounded-2xl text-[9px] font-black text-slate-600 uppercase tracking-widest">
        <span>{t(`Payments & Advances (${myAdvances.length})`, `ادائیگیاں و ایڈوانس (${myAdvances.length})`)}</span>
...
const URDU_AREA_NAMES = {
  ...
  'R17 Warehouse → Khyber Shop (Stock Transfer)':'R17 گودام → خیبر دکان (ڈینسو ہال)',
  'Sohrab Goth Bus Adda → R17 Warehouse':'سہراب گوٹھ بس اڈہ → R17 (الہلال سوسائٹی)',
...
const AREA_DISTANCES = {
  ...
  'R17 Warehouse → Khyber Shop (Stock Transfer)':8,'Sohrab Goth Bus Adda → R17 Warehouse':17,
...
const AREA_DISTANCES_SHOP = {
  ...
  'R17 Warehouse → Khyber Shop (Stock Transfer)':0,'Sohrab Goth Bus Adda → R17 Warehouse':25,
      ...
      <div className="p-4 space-y-3">
        ...
        {showPay && (
          <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-3 space-y-2">
            ...
            <input placeholder="Note — e.g. کرایہ ادائیگی" value={payNote} onChange={e => setPayNote(e.target.value)}
