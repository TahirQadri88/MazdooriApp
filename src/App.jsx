...
const KARACHI_AREAS = [
  ...
  // --- M.A. Jinnah Road ---
  { name: 'Bohri Bazaar', fromShop: 1, fromWarehouse: 13 },
  { name: 'Jama Cloth Market', fromShop: 2, fromWarehouse: 13 },
  { name: 'Lighthouse', fromShop: 2, fromWarehouse: 12 },
  { name: 'Lasbela Chowk', fromShop: 3, fromWarehouse: 13 },
  { name: 'Civil Hospital', fromShop: 3, fromWarehouse: 12 },
  { name: 'Dow University Hospital', fromShop: 3, fromWarehouse: 12 },
  { name: 'Frere Hall', fromShop: 4, fromWarehouse: 11 },
  { name: 'Tibet Centre', fromShop: 4, fromWarehouse: 12 },
  { name: 'Guru Mandir', fromShop: 4, fromWarehouse: 10 },
  { name: 'Ayesha Manzil', fromShop: 5, fromWarehouse: 10 },
